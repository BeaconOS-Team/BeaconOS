...
chmod u+x installer_tool_kit/_entry.sh
DATA=$1
...
##################################################################
# Credited From: VinGarcia at June 22, 2016                      #
# Orginal From: https://unix.stackexchange.com/a/291284/533550   #
# Some edits had been made                                       #
##################################################################